...
function Formulario({setPacientes, pacientes}) {
  ...
  return (
    ...
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <form className="bg-white shadow-md rounded-lg py-10 px-5 my-10" onSubmit={handleSubmit}>
        <div className="mb-5">
        ...
        <div className="mb-5">
            ...
            <input id="alta" type="date" className="border-2 w-full p-2 mt-2 
              placeholder-gray-400 rounded-md" value={alta} onChange={(e) => setAlta(e.target.value)} />  
        </div>

        <div className="mb-5">
            <label htmlFor="sintomas" className="block text-gray-700 uppercase font-bold">Síntomas</label>
            <textarea  id="sintomas" className="border-2 w-full p-2 mt-2 
              placeholder-gray-400 rounded-md" placeholder="Describe los Síntomas" value={sintomas} onChange={(e) => setSintomas(e.target.value)} />
        </div>
        ...
        {error && <div><Error mensaje='Todos los campos son obligatorios'/></div>}
      </form>
    </div>
    </>
  )
